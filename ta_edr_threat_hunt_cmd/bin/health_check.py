...
class EDRHealthCheck:
    """
    Health check utility for the ta_edr_threat_hunt_cmd app.
    Verifies configuration, API connectivity, and KV Store status.
    """
    
    def __init__(self, splunk_url, username, password, app_name='ta_edr_threat_hunt_cmd'):
        """
        ...
        Args:
            ...
            app_name (str): App name (default: ta_edr_threat_hunt_cmd)
        """
...
def main():
    ...
    parser.add_argument('--app', default='ta_edr_threat_hunt_cmd', help='App name (default: ta_edr_threat_hunt_cmd)')
